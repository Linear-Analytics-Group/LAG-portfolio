"""Unit tests for lag_data_utils.clients.base.

Covers BaseClient, AuthenticationError.
"""
...
def test_base_client_cannot_be_instantiated_directly() -> None:
    """BaseClient is abstract — it fixes the auth contract, not an impl."""
    with pytest.raises(TypeError):
        BaseClient()  # type: ignore[abstract]


def test_authentication_error_is_an_exception() -> None:
    """AuthenticationError is the root of the auth-failure hierarchy."""
