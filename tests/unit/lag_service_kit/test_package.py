"""Unit tests for lag_service_kit's own package metadata.

Covers __version__.
"""

import lag_service_kit
import pytest
...
def test_version_is_a_non_empty_string() -> None:
    ...
    """
    assert isinstance(lag_service_kit.__version__, str)
    assert lag_service_kit.__version__ != ""
