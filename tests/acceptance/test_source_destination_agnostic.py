...
def test_csv_and_json_sources_produce_identical_deduplicated_records(csv_source, json_source):
...
@pytest.mark.acceptance
def test_swapping_source_requires_no_new_destination_class(csv_source, json_source):
...
@pytest.mark.acceptance
def test_shipped_mock_feeds_are_themselves_interchangeable():
